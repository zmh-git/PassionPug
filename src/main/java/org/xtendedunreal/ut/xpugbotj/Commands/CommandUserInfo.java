package org.xtendedunreal.ut.xpugbotj.Commands;
...
import org.xtendedunreal.ut.xpugbotj.Configuration;

public class CommandUserInfo implements MessageCreateListener {
	 /*
    ...
    public void onMessageCreate(MessageCreateEvent event) {
        ...
        if (event.getMessageContent().equalsIgnoreCase(Configuration.prefix+"usernfo") || event.getMessageContent().equalsIgnoreCase(Configuration.prefix+"ui")) {
